      ...
      {updateClicked ?
        ...
        <div className="DoctorDetails">
          ...
          <div className="mt-5 mb-5">
            ...
            <h3 className="card-header mt-5 mb-5">Dr.{doctor.last_name}'s page!!' </h3>
            <span className="d-block"><b>Name:</b> {doctor.first_name} {doctor.last_name}</span>
            <span className="d-block" ><b>Email:</b> {doctor.email}</span>
          </div>
